...
{
	getopt.parse -1 "pattern:str:+:$1" "exp:str:-:$2" "count:int:+:$3" "flag:uint:+:$4" "funcname:func:+:$5"
...
{
	getopt.parse -1 "pattern:str:+:$1" "exp:str:-:$2" "match:uint:+:$3" "flag:uint:+:$4" "funcname:func:+:$5"
