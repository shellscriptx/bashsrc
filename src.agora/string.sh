...
{
	getopt.parse -1 "exp:str:-:$1" "old:str:-:$2" "count:int:+:$3" "funcname:func:+:$4"
...
{
	getopt.parse -1 "exp:str:-:$1" "old:str:-:$2" "match:int:+:$3" "funcname:func:+:$4"
...
{
	getopt.parse -1 "exp:str:-:$1" "funcname:func:+:$2"
...
{
	getopt.parse -1 "exp:str:-:$1" "slice:slice:+:$2"
...
{
	getopt.parse -1 "exp:str:-:$1" "flag:str:-:$2"
...
{
    getopt.parse -1 "exp:str:-:$1" "sub:str:-:$2"
