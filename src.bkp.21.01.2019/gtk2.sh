...
# widgets
readonly GTK_WIDGET_BUTTON=1
readonly GTK_WIDGET_TOOGLE_BUTTON=2
readonly GTK_WIDGET_PASSWORDBOX=3   
readonly GTK_WIDGET_SPIN_BUTTON=4
readonly GTK_WIDGET_ENTRY=5
readonly GTK_WIDGET_ENTRY_READONLY=6
readonly GTK_WIDGET_CHECKBOX=7
readonly GTK_WIDGET_COMBOBOX=8
readonly GTK_WIDGET_COMBOBOX_EDIT=9
readonly GTK_WIDGET_ENTRY_COMPLETE=10
readonly GTK_WIDGET_FILE_SELECT=11
readonly GTK_WIDGET_FILES_SELECT=12
readonly GTK_WIDGET_FILE_CREATE=13
readonly GTK_WIDGET_DIR_SELECT=14
readonly GTK_WIDGET_DIRS_SELECT=15
readonly GTK_WIDGET_DIR_CREATE=16
readonly GTK_WIDGET_FONT_BUTTON=17
readonly GTK_WIDGET_DATE_BUTTON=18
readonly GTK_WIDGET_SCALE_BUTTON=19
readonly GTK_WIDGET_COLOR_BUTTON=20
readonly GTK_WIDGET_LABEL=21
readonly GTK_WIDGET_TEXTBOX=22

readonly GTK_COLUMN_TEXT=1
readonly GTK_COLUMN_NUMBER=2
readonly GTK_COLUMN_SIZE=3
readonly GTK_COLUMN_FLOAT=4
readonly GTK_COLUMN_CHECK=5
readonly GTK_COLUMN_RADIO=6
readonly GTK_COLUMN_PROGRESS=7
readonly GTK_COLUMN_HIDE=8
readonly GTK_COLUMN_TOOLTIP=9

readonly GTK_BAR_NORMAL=1
readonly GTK_BAR_REVERSE=2
readonly GTK_BAR_PULSE=3

readonly GTK_PICTURE_NORMAL=1
readonly GTK_PICTURE_FIT=2

readonly GTK_FORM_POS_TOP=1
readonly GTK_FORM_POS_BOTTOM=2
readonly GTK_FORM_POS_LEFT=3
readonly GTK_FORM_POS_RIGHT=4

readonly GTK_TIMEOUT_POS_TOP=1
readonly GTK_TIMEOUT_POS_BOTTOM=2
readonly GTK_TIMEOUT_POS_LEFT=3
readonly GTK_TIMEOUT_POS_RIGHT=4

readonly GTK_TEXT_ALIGN_LEFT=1
readonly GTK_TEXT_ALIGN_CENTER=2
readonly GTK_TEXT_ALIGN_RIGHT=3
readonly GTK_TEXT_ALIGN_FILL=4

readonly GTK_BUTTON_LAYOUT_SPREAD=1
readonly GTK_BUTTON_LAYOUT_EDGE=2
readonly GTK_BUTTON_LAYOUT_START=3
readonly GTK_BUTTON_LAYOUT_END=4
readonly GTK_BUTTON_LAYOUT_CENTER=5

readonly GTK_COLOR_MODE_HEX=1
readonly GTK_COLOR_MODE_RGB=2

readonly GTK_COMPLETE_ANY=1
readonly GTK_COMPLETE_ALL=2
readonly GTK_COMPLETE_REGEX=3

readonly GTK_GRID_LINE_HORIZONTAL=1
readonly GTK_GRID_LINE_VERTICAL=2
readonly GTK_GRID_LINE_BOTH=3

readonly GTK_ELLIPSIZE_NONE=1
readonly GTK_ELLIPSIZE_START=2
readonly GTK_ELLIPSIZE_MIDDLE=3
readonly GTK_ELLIPSIZE_END=4

readonly GTK_PRINT_TYPE_TEXT=1
readonly GTK_PRINT_TYPE_IMAGE=2
readonly GTK_PRINT_TYPE_RAW=3

readonly GTK_TAB_POS_TOP=1
readonly GTK_TAB_POS_BOTTOM=2
readonly GTK_TAB_POS_LEFT=3
readonly GTK_TAB_POS_RIGHT=4

readonly GTK_SIGNAL_SIGHUP=1
readonly GTK_SIGNAL_SIGINT=2
readonly GTK_SIGNAL_SIGQUIT=3
readonly GTK_SIGNAL_SIGILL=4
readonly GTK_SIGNAL_SIGTRAP=5
readonly GTK_SIGNAL_SIGABRT=6
readonly GTK_SIGNAL_SIGBUS=7
readonly GTK_SIGNAL_SIGFPE=8
readonly GTK_SIGNAL_SIGKILL=9
readonly GTK_SIGNAL_SIGUSR1=10
readonly GTK_SIGNAL_SIGSEGV=11
readonly GTK_SIGNAL_SIGUSR2=12
readonly GTK_SIGNAL_SIGPIPE=13
readonly GTK_SIGNAL_SIGALRM=14
readonly GTK_SIGNAL_SIGTERM=15
readonly GTK_SIGNAL_SIGSTKFLT=16
readonly GTK_SIGNAL_SIGCHLD=17
readonly GTK_SIGNAL_SIGCONT=18
readonly GTK_SIGNAL_SIGSTOP=19
readonly GTK_SIGNAL_SIGTSTP=20
readonly GTK_SIGNAL_SIGTTIN=21
readonly GTK_SIGNAL_SIGTTOU=22
readonly GTK_SIGNAL_SIGURG=23
readonly GTK_SIGNAL_SIGXCPU=24
readonly GTK_SIGNAL_SIGXFSZ=25
readonly GTK_SIGNAL_SIGVTALRM=26
readonly GTK_SIGNAL_SIGPROF=27
readonly GTK_SIGNAL_SIGWINCH=28
readonly GTK_SIGNAL_SIGIO=29
readonly GTK_SIGNAL_SIGPWR=30
readonly GTK_SIGNAL_SIGSYS=31
readonly GTK_SIGNAL_SIGRTMIN=32
readonly GTK_SIGNAL_SIGRTMIN1=33
readonly GTK_SIGNAL_SIGRTMIN2=34
readonly GTK_SIGNAL_SIGRTMIN3=35
readonly GTK_SIGNAL_SIGRTMIN4=36
readonly GTK_SIGNAL_SIGRTMIN5=37
readonly GTK_SIGNAL_SIGRTMIN6=38
readonly GTK_SIGNAL_SIGRTMIN7=39
readonly GTK_SIGNAL_SIGRTMIN8=40
readonly GTK_SIGNAL_SIGRTMIN9=41
readonly GTK_SIGNAL_SIGRTMIN10=42
readonly GTK_SIGNAL_SIGRTMIN11=43
readonly GTK_SIGNAL_SIGRTMIN12=44
readonly GTK_SIGNAL_SIGRTMIN13=45
readonly GTK_SIGNAL_SIGRTMIN14=46
readonly GTK_SIGNAL_SIGRTMIN15=47
readonly GTK_SIGNAL_SIGRTMAX14=48
readonly GTK_SIGNAL_SIGRTMAX13=49
readonly GTK_SIGNAL_SIGRTMAX12=50
readonly GTK_SIGNAL_SIGRTMAX11=51
readonly GTK_SIGNAL_SIGRTMAX10=52
readonly GTK_SIGNAL_SIGRTMAX9=53
readonly GTK_SIGNAL_SIGRTMAX8=54
readonly GTK_SIGNAL_SIGRTMAX7=55
readonly GTK_SIGNAL_SIGRTMAX6=56
readonly GTK_SIGNAL_SIGRTMAX5=57
readonly GTK_SIGNAL_SIGRTMAX4=58
readonly GTK_SIGNAL_SIGRTMAX3=59
readonly GTK_SIGNAL_SIGRTMAX2=60
readonly GTK_SIGNAL_SIGRTMAX1=61
readonly GTK_SIGNAL_SIGRTMAX=62

# Objetos GTK
readonly -a __GTK_OBJECT=(gtk_calendar_t
gtk_color_t
gtk_dnd_t
gtk_entry_t
gtk_file_t
...
# Flags (widgets)
readonly -a __GTK_FLAG_WIDGET=([1]=BTN FBTN H NUM '' RO CHK CB CBE CE FL MFL SFL DIR MDIR CDIR FN DT SCL CLR LBL TXT)
readonly -a __GTK_FLAG_WIDGET_COLUMN=([1]=TEXT NUM SZ FLT CHK RD BAR HD TIP)
readonly -a __GTK_FLAG_WIDGET_BAR=([1]=NORM RTL PULSE)
readonly -a __GTK_FLAG_PICTURE_SIZE=([1]=ORIG FIT)
readonly -a __GTK_FLAG_FORM_POS=([1]=TOP BOTTOM LEFT RIGHT)
readonly -a __GTK_FLAG_TIMEOUT_POS=([1]=TOP BOTTOM LEFT RIGHT)
readonly -a __GTK_FLAG_TEXT_ALIGN=([1]=LEFT CENTER RIGHT FILL)
readonly -a __GTK_FLAG_BUTTON_LAYOUT=([1]=SPREAD EDGE START END CENTER)
readonly -a __GTK_FLAG_SIGNAL=(SIGHUP SIGINT SIGQUIT SIGILL SIGTRAP SIGABRT SIGBUS SIGFPE SIGKILL SIGUSR1 SIGSEGV SIGUSR2 SIGPIPE SIGALRM SIGTERM SIGSTKFLT SIGCHLD SIGCONT SIGSTOP SIGTSTP SIGTTIN SIGTTOU SIGURG SIGXCPU SIGXFSZ SIGVTALRM SIGPROF SIGWINCH SIGIO SIGPWR SIGSYS SIGRTMIN SIGRTMIN+1 SIGRTMIN+2 SIGRTMIN+3 SIGRTMIN+4 SIGRTMIN+5 SIGRTMIN+6 SIGRTMIN+7 SIGRTMIN+8 SIGRTMIN+9 SIGRTMIN+10 SIGRTMIN+11 SIGRTMIN+12 SIGRTMIN+13 SIGRTMIN+14 SIGRTMIN+15 SIGRTMAX-14 SIGRTMAX-13 SIGRTMAX-12 SIGRTMAX-11 SIGRTMAX-10 SIGRTMAX-9 SIGRTMAX-8 SIGRTMAX-7 SIGRTMAX-6 SIGRTMAX-5 SIGRTMAX-4 SIGRTMAX-3 SIGRTMAX-2 SIGRTMAX-1 SIGRTMAX)
readonly -a __GTK_FLAG_COLOR_MODE=([1]=HEX RGB)
readonly -a __GTK_FLAG_COMPLETE=([1]=ANY ALL REGEX)
readonly -a __GTK_FLAG_GRID_LINES=([1]=HOR VERT BOTH)
readonly -a __GTK_FLAG_ELLIPSIZE=([1]=NONE START MIDDLE END)
readonly -a __GTK_FLAG_PRINT_TYPE=([1]=TEXT IMAGE RAW)
readonly -a __GTK_FLAG_TAB_POS=([1]=TOP BOTTOM LEFT RIGHT)
...
# widget
gtk_widget_t.__add__	type		uint 			\
			label		str			\
			icon		str			\
			tooltip		str			\
			id		uint 			\
...
gtk_widget_button_t.__add__	label		str	\
				...
				id		uint
# coluna
gtk_widget_column_t.__add__	type	uint	\
				label	str

# Barra de progresso
gtk_widget_bar_t.__add__	type	uint	\
				label	str
...
function gtk.init()
{
	...
	for gtk_object in "$@"; do
				...
				if [[ $obj ]]; then
					...
					for ((i=0; i < $($obj.__sizeof__); i++)); do
						...
						if [[ $widget != @(${widgets[@]// /|}) ]]; then
							...
							return $?
						elif [[ $widget == @($GTK_WIDGET_BUTTON|$GTK_WIDGET_TOOGLE_BUTTON) ]]; then
			...
			gtk_list_t)
				...
				if [[ $column ]]; then
					...
					for ((i=0; i < $($column.__sizeof__); i++)); do
						lstcolumns[$i]="--column '$($column[$i].label):${__GTK_FLAG_WIDGET_COLUMN[$($column[$i].type)]}'"
					done
				fi
				;;
			gtk_multi_progress_t)
				...
				if [[ $bar ]]; then
					...
					for ((i=0; i < $($bar.__sizeof__); i++)); do
						bars[$i]="--bar '$($bar[$i].label):${__GTK_FLAG_WIDGET_BAR[$($bar[$i].type)]}'"
					done
				fi
				;;
			gtk_picture_t)
		...
		timeout_indicator=${timeout_indicator:+${__GTK_FLAG_TIMEOUT_POS[$timeout_indicator]}}
